/**
 * Author: Ruan Petrus
 * Description: Push-Relabel implementation of the cost-scaling algorithm Operates on integers, costs are multiplied by N!!
 * Time: Runs in O( <max_flow> * log(V * max_edge_cost)) = O( V^3 * log(V * C)) Really fast in practice, 3e4 edges are fine.
 * Memory: O(n)
